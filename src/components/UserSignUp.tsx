...
const UserSignUp = () => {
  ...
  const updateStorageLogin = (_: any, { data: {
    ...
    <Card>
      ...
      <Input
       disabled={loading}
        ...
        required
      />
      <Button disabled={loading} onClick={loginUser}>Log in</Button>
      <Button  disabled={loading} onClick={signInUser} primary>Sign Up</Button>
      </Content>
    </Card>
  );
};
